...
//   return (
//     <>
//       <div className="container mx-auto px-18 py-4 text-white">
//         {/*  Link */}
//         <div>
//           <Link
//             href="/"
//             className="flex gap-3 text-sm text-gray-400 tracking-wide "
//           >
...
//       <div className="container mx-auto px-18 py-4 cust-font text-[#4A4A4A]">
//         <div >
//           <p className="mt-5 mb-10">Getting your house cleaned in the UAE is only a few clicks away. Justlife is here for all your home needs, from house cleaning to hair salon services. House cleaning is a serious job, so you can let us do it to save time and energy</p>


//           <h3 className=" text-md font-bold mt-5 mb-2 ">
//             Simple, Convenient, and Affordable Way to Book House Cleaning Services
//           </h3>
//           <p className=" mt-5 mb-3">Making your life easier is simple with Justlife. Our services are here for you for every part of your life, and you won't have to worry about cleaning your house ever again. You can hire a <strong>house cleaning service</strong> from our website and mobile app with a few simple clicks. If you are looking for a cleaning service in the UAE, look no further!</p>
//           <p className="mt-5">
//             Here's why you should hire a professional cleaning company and more details on the servic</p>

//           <h3 className=" text-md font-bold mt-10 mb-8 ">
...
export default function HouseCleaningPage() {
  return (
    <>
      ...
      <div className=" cust-font text-[#4A4A4A]">
        <div>
      ...
      <div className="cust-font text-[#4A4A4A]">
        <div>
          ...
          <p className="mt-5 mb-5">
            <Link href=""
              className="text-blue-400 hover:text-[#4A4A4A]">
              Deep cleaning
            </Link> is another service offered by Justlife, which involves even more things. When you hire professionals for deep cleaning, they will also clean air filters, ceiling fans, wash curtains, and more.
          </p>
          ...
          <p className="mt-5 mb-5">
            Many people hate cleaning bathrooms because they can get dirty very quickly. You probably don't have time to clean your bathroom comprehensively when you come back from work. Then just let us know, and we will send the best professionals for you. 
            The   <Link href=""
              className="text-blue-400 hover:text-[#4A4A4A]">
              bathroon cleaning
            </Link>   includes scrubbing sinks and bathtubs, disposing of waste in your bathroom, and cleaning the mats. Professional <Link href=""
              className="text-blue-400 hover:text-[#4A4A4A]">
              home cleaning services
            </Link> is essential for bathrooms as a dirty bathroom is both unpleasant and a health hazard.
          </p>
